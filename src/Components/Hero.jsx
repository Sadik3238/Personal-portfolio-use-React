    ...
    return (
        <div className='bg-black text-white text-center py-16'>
            ...
            <h1 className='text-4xl font-bold'>I'm {""}
                <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-400'>,Junior Frontend Developer</span>
            </h1>
            ...
            <div className='mt-8 space-x-4'>
                ...
                <button className='bg-gradient-to-r from-pink-300 to-yellow-400 text-white hidden md:inline
